...
WebUI.click(findTestObject('Object Repository/LoginPageObjects/input_Password_commit'))

WebUI.verifyElementPresent(findTestObject('Object Repository/LoginPageObjects/h2_Hello, Aditee Ranade_East Midlands'), 0)

WebUI.navigateToUrl('https://next.malinko-uat.co.uk/c/1056293')

WebUI.verifyElementPresent(findTestObject('PatientPageObjects/PatientName'), 0)

WebUI.verifyElementText(findTestObject('PatientPageObjects/PatientName'), 'Patient 1056293')
